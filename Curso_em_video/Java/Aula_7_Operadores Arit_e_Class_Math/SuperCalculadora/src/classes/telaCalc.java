...
public class telaCalc extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Resto da Div por 2");
...
//         Resto da Divisão por 2;
         int r = valor % 2;
         lblRestoDiv.setText(Integer.toString(r));
         
//         Elevado ao cubo;
         double a = Math.pow(valor, 3);
         lblCubo.setText(Double.toString(a));
         
//         Raiz Quadrada
         double b = Math.sqrt(valor);
         lblRaizQua.setText(String.format("%.2f",b));
         
//         Raiz cubica;
         double c = Math.cbrt(valor);
         lblRaizCub.setText(String.format("%.2f",c));
         
//         Valor absoluto
         int d = Math.abs(valor);
         lblAbs.setText(Integer.toString(d));
